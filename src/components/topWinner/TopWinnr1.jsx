    ...
    <div className="row">
      <div className="col-lg-3 col-md-6 col-sm-6">
        <div className="winner-card winner-alpha">
          ...
          <div className="winner-info">
            <h5 className="winner-name"><Link legacyBehavior href="/winner">Brooklyn Simmons</Link></h5>
      ...
      <div className="col-lg-3 col-md-6 col-sm-6">
        <div className="winner-card winner-alpha">
          ...
          <div className="winner-info">
            <h5 className="winner-name"><Link legacyBehavior href="/winner">Cameron Williamson</Link></h5>
      ...
      <div className="col-lg-3 col-md-6 col-sm-6">
        <div className="winner-card winner-alpha">
          ...
          <div className="winner-info">
            <h5 className="winner-name"><Link legacyBehavior href="/winner">Marvin McKinney</Link></h5>
      ...
      <div className="col-lg-3 col-md-6 col-sm-6">
        <div className="winner-card winner-alpha">
          ...
          <div className="winner-info">
            <h5 className="winner-name"><Link legacyBehavior href="/winner">Savannah Nguyen</Link></h5>
